...
## Project Structure
    ...
    ├── testapiautodatamode_53657  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_53657`
...
2. Clone this repo and `cd testapiautodatamode_53657`
